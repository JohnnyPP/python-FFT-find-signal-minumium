...
#phase=0 minimum is in 270 degrees fftPhaseHarmonic[1]=-90 max is 90 abs(fftPH[1])
#phase=10 minimum is in 260 degrees fftPhaseHarmonic[1]=-80 max is 80
...
#phase=60 minimum is in 210 degrees fftPhaseHarmonic[1]=-30 max is 30
#phase=70 minimum is in 200 degrees fftPhaseHarmonic[1]=-20
#phase=80 minimum is in 190 degrees fftPhaseHarmonic[1]=-10
#phase=90 minimum is in 180 degrees fftPhaseHarmonic[1]=0   max is 0
#phase=100 minimum is in 170 degrees fftPhaseHarmonic[1]=10 max 360-10
...
#phase=140 minimum is in 130 degrees fftPhaseHarmonic[1]=50 max 360 - 50
...
#phase=260 minimum is in 10 degrees fftPhaseHarmonic[1]=170 max 360 - 170
#phase=270 minimum is in 0 degrees fftPhaseHarmonic[1]=-180 max 180
...
plt.figure("Signal with fit and found min/max")
p1, = plt.plot(np.rad2deg(x), amplitudeScaledFFT[1]*y, linewidth=2)   #fit
p2, = plt.plot(np.rad2deg(x), ynoise, 'ro', linewidth=3)              #signal
plt.title("Signal with fit and found min/max")
...
plt.vlines(FindMaximumPhase(phaseDegreesFFT[1]), 
           -amplitudeScaledFFT[1], amplitudeScaledFFT[1],linewidth=3,
            color='g',linestyles='dashed') 
            #draws the vertical line with the found maximum
plt.legend([p1, p2], ["Fit", "Signal"])
plt.grid(True)
plt.show()
